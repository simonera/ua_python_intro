...
- Deep Learning
  - See [presentation]() and [Jupyter notebook](https://github.com/simonera/ua_python_intro/blob/main/11_1_llama_chatbot.ipynb). All original materials created by Mithun Paul. 
- Prompt Engineering
- AI Tools Landscape
